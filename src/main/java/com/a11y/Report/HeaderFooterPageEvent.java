...
public class HeaderFooterPageEvent extends PdfPageEventHelper {
    ...
    private void addHeader(PdfWriter writer){
        ...
        try {
            ...
            text.addElement(new Phrase("a11y Execution Report", new Font(Font.FontFamily.HELVETICA, 12)));
            text.addElement(new Phrase("https://dequeuniversity.com/rules/", new Font(Font.FontFamily.HELVETICA, 8)));
            header.addCell(text);
